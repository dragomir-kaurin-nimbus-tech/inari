    ...
    <section id="about" aria-labelledby="about-heading">
      <div className="container about">
        <div className="about-text">
          <span className="subtitle">O NAMA</span>
          <h2 id="about-heading">
            Kreiramo vizuelna
            <br />
          ...
          <p>
            Pomažemo kompanijama da kroz kvalitetan dizajn izgrade prepoznatljiv
            vizuelni identitet. Tokom tog perioda učestvovali smo u realizaciji
            preko 50 projekata za male biznise i velike kompanije.
            <br />
            <br />
            Naš rad obuhvata kompletan proces – od kreiranja logotipa, brendinga
            ...
            <br />
            <br />
            Verujemo da dobar dizajn nije samo lep izgled, već alat koji gradi
